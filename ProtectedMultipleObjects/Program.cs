...
namespace ProtectedMultipleObjects
{
    ...
    class RescueCat : Cat
    {
        protected string _rescueLocation;
        protected string _favoriteToy;

        public RescueCat() : base()
        {
            _rescueLocation = string.Empty;
            _favoriteToy = string.Empty;
        }

        public RescueCat(string name, int age, string color, string rescueLocation, string favoriteToy)
            : base(name, age, color)
        {
        ...
        public void setFavoriteToy(string toy) { _favoriteToy = toy; }
        public string getFavoriteToy() { return _favoriteToy; }
        ...
        public override void addChange()
        {
            ...
            _favoriteToy = Console.ReadLine();
        }

        public override void print()
        {
            base.print();
            Console.WriteLine($"Rescue Location: {_rescueLocation}");
            Console.WriteLine($"Favorite Toy: {_favoriteToy}");
        }
    }
